  ...
  return (
    <div className='space-y-6'>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="font-semibold text-theme-primary">{spell.name}</div>
      ...
      <div className='flex justify-between'>
        <button onClick={prevStep} className='px-4 py-2 bg-theme-quaternary text-theme-primary rounded-lg hover:bg-theme-hover flex items-center gap-2'>
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg flex items-center gap-2 ${
            allSelectionsComplete
              ? 'bg-accent-red-dark text-theme-primary hover:bg-accent-red'
