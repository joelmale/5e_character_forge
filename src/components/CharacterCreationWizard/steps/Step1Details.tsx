...
const RandomizeAllButton: React.FC<RandomizeAllButtonProps> = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`px-4 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 rounded-lg text-theme-primary font-bold transition-all flex items-center gap-2 shadow-lg ${className}`}
    ...
    <div className='space-y-4'>
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 p-3 bg-theme-tertiary text-theme-primary rounded-lg focus:ring-red-500 focus:border-red-500"
        />
        <button
          onClick={() => setShowNameGenerator(true)}
          className="px-4 py-3 bg-accent-purple hover:bg-accent-purple-light text-theme-primary rounded-lg transition-colors flex items-center gap-2"
      ...
      <div>
        ...
        <select
          ...
          className="w-full p-3 bg-theme-tertiary text-theme-primary rounded-lg focus:ring-red-500 focus:border-red-500"
        >
          ...
          <div className="border-t border-theme-primary pt-3">
            ...
            <div className="flex flex-wrap gap-2">
              {selectedBackground.skill_proficiencies.map(skill => (
                <span key={skill} className="px-2 py-1 bg-blue-700 text-theme-primary text-xs rounded">
                  {skill}
                </span>
              ))}
            </div>
            ...
            <div className="border-t border-theme-primary pt-3">
              ...
              <div className="flex flex-wrap gap-2">
                {selectedBackground.languages.map(language => (
                  <span key={language} className="px-2 py-1 bg-accent-green-dark text-theme-primary text-xs rounded">
                    {language}
                  </span>
                ))}
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-theme-secondary rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-2xl font-bold text-theme-primary">Name Generator</h3>
              <button
            ...
            {currentGeneratedName && (
              <div className="bg-theme-tertiary rounded-lg p-4 mb-6">
                <div className="flex items-center justify-between mb-2">
                  <h4 className="text-xl font-bold text-theme-primary">{currentGeneratedName.name}</h4>
      ...
      <button
        ...
        className="w-full py-3 bg-accent-red hover:bg-accent-red-light rounded-xl text-theme-primary font-bold transition-colors disabled:bg-theme-quaternary"
      >
