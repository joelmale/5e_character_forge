  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-theme-primary rounded-lg p-5 border-2 border-accent-gold border-opacity-30">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-theme-text-secondary">{character.race} {character.class}</p>
          </div>
          <div className="text-right">
            <p className="text-sm text-theme-text-secondary">Level</p>
        ...
        <div className="grid grid-cols-2 gap-4 pt-4 border-t border-theme-border">
          <div>
            <p className="text-sm text-theme-text-secondary">Max HP</p>
            <p className="text-lg font-semibold text-theme-text">
              {character.maxHitPoints} → {character.maxHitPoints + choices.hpGained}
              <span className="text-accent-gold ml-2">+{choices.hpGained}</span>
            </p>
          </div>
          <div>
            <p className="text-sm text-theme-text-secondary">Prof. Bonus</p>
            <p className="text-lg font-semibold text-theme-text">
      ...
      <div className="flex justify-between pt-4">
        ...
        <button
          onClick={onComplete}
          className="px-6 py-3 bg-accent-gold text-theme-primary font-semibold rounded-lg hover:bg-opacity-90 transition-colors flex items-center"
        >
